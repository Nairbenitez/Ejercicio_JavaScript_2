...
// Instrucción: Crea una función que reciba un número entero positivo y utilice un bucle `while` para imprimir todos los números desde ese número hasta 0.let
...
function obtenerDiaSemana(dia) {
    switch (dia) {
        ...
        break;
        default:
        console.log("ingresa un numero del 1 al 7.");
